    ...
    switch (menuSelection)
    {
        ...
        case "3":
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: " && ourAnimals[i, 2] == "Age: ?")
                {
                    do
                    {
                        System.Console.WriteLine($"Please put in an age value for {ourAnimals[i, 0]}:");
                        readResult = Console.ReadLine();
                        if (readResult != null)
                        {
                            animalAge = readResult;
        ...
        case "4":
            for (int i = 0; i < maxPets; i++)
            {
                ...
                {
                    System.Console.WriteLine($"Please enter a nickname for {ourAnimals[i, 0]}");
                    readResult = Console.ReadLine();
                ...
                {
                    System.Console.WriteLine($"Please enter a Personality Description for {ourAnimals[i, 0]}");
                    readResult = Console.ReadLine();
